  ...
  return (
    <div className="mx-auto w-full max-w-3xl px-4 py-12 sm:px-6">
      ...
      <article className="legal-prose">
        ...
        <p>
          {SHIPPING_ESTIMATE_SUMMARY} See our{" "}
        ...
        <h3>Where does Y2KASE ship?</h3>
        <p>
          We currently ship to {SHIPPING_MARKETS_SUMMARY}. Available rates and
          any free-shipping threshold appear at checkout.
        </p>
